...
function fish_hline_prompt
	...
	set -q fish_color_user; or set -l fish_color_user (hline_prompt_generate_color $USER)
	set -q fish_color_host; or set -l fish_color_host (hline_prompt_generate_color $hostname)
